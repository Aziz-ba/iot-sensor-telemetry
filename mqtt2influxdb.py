...
INFLUXDB_PASSWORD =
INFLUXDB_DATABASE = 
MQTT_CLIENT_ID    = "Aziz-id"
MQTT_USERNAME     = os.environ.get("MQTT_USERNAME", "mqtt_user")
MQTT_PASSWORD     = os.environ.get("MQTT_PASSWORD", "mqtt_pass")
MQTT_HOST         = os.environ.get("MQTT_HOST", "your.mqtt.broker")
MQTT_PORT         = 1883
